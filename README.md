...
- **Kostka** (1–6)
- **Liczba** z zakresu od–do (konfigurowalny)
...
1. Wypchnij pliki do repozytorium.
2. Settings → Pages → Source: gałąź z plikiem `index.html` (katalog `/root`).
3. Aplikacja będzie dostępna pod adresem GitHub Pages repozytorium.
